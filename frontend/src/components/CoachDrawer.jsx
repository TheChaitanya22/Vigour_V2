  ...
  const menuItems = [
    {
      label: "Create Course",
      icon: PlusCircle,
      path: "/coach/create-course",
      action: () => navigate("/coach/create-course"),
    },
    {
      label: "My Courses",
      icon: BookOpen,
      path: "/coach/dashboard",
      action: () => navigate("/coach/dashboard"),
    },
  ];
          ...
          <div className="pl-20 bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">Vigour Creator</p>
              </div>
            </div>
          </div>
...
export default CoachSidebarDrawer;
